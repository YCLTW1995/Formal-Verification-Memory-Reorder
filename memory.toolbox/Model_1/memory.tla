...
macro do_action(target) begin \*\* Also set chosen target to false
  if target.b = 1 then
...
\* Last modified Sun Dec 08 18:33:38 EST 2019 by linyungching
